    ...
    <>
      <div className=" md:py-20 pt-20 ">
        <div className="container mx-auto  duration-300 ">
          <ul className="flex flex-wrap gap-x-4 gap-y-4 justify-center items-center duration-300">
            {/* HTML icon */}
            <li title="HTML" className="cursor-pointer duration-300">
              <svg
            ...
            {/* css icon */}
            <li title="CSS" className=" cursor-pointer duration-300">
              <svg
                aria-label="CSS"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 128 128"
            ...
            {/* JavaScript icon */}
            <li title="JS" className="cursor-pointer duration-300">
              <svg
                aria-label="JS"
                xmlns="http://www.w3.org/2000/svg"
                width="50"
            ...
            {/* TypeScript icon */}
            <li title="TS" className="cursor-pointer duration-300">
              <svg
                aria-label="TS"
                height="50"
            ...
            {/* React icon */}
            <li title="REACT.JS" className=" cursor-pointer duration-300 ">
              <svg
                aria-label="REACT"
                xmlns="http://www.w3.org/2000/svg"
                width="55"
            ...
            {/* Next.js icon */}
            <li title="NEXT.JS" className="cursor-pointer duration-300">
              <svg
                aria-label="Next.js"
                height="55"
                width="55"
            ...
            {/* REDUX icon */}
            <li title="REDUX TOOLKIT" className="cursor-pointer duration-300 ">
              <svg
                aria-label="REDUX"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 100 100"
            ...
            {/* Tailwind CSS icon */}
            <li title="TAILWIND CSS" className=" cursor-pointer duration-300 ">
              <svg
            ...
            {/* SCSS icon */}
            <li title="SCSS" className=" cursor-pointer duration-300 ">
              <svg
                aria-label="SCSS"
                xmlns="http://www.w3.org/2000/svg"
                 height="50"
